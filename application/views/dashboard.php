...
<script type="text/javascript">
    ...
    station = "<?php echo $userdata['station']; ?>";
 ...
 #trigger-upload {
    ...
    <body class="c-layout-header-fixed c-layout-header-6-topbar">
       ...
       <!-- BEGIN: CONTENT/USER/LOGIN-FORM -->
            ...
            <div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
                <div class="container" >
                    ...
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        ...
                        <li>/</li>
                        <li class="c-state_active">Dashboard</li>
                    </ul>
                </div>
            </div>
        ...
        <!-- 
            <script type="text/javascript" src="lib/js/google/lines/lines.js"></script>
    <script type="text/javascript" src="lib/js/google/lines/area.js"></script>
    
         -->
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/lib/js/google/bars/column_stacked.js"></script> 
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/lib/js/google/lines/area_stacked.js"></script>
        <script>
