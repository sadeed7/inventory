       ...
       <!--  <div  style=" background: #fafafa url('assets/images/BACK 1.png');"> -->
        ...
        <div class="c-layout-page">
            ...
            <div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
                <div class="container" >
                    <div class="c-page-title c-pull-left">
                        <h3 class="c-font-uppercase c-font-bold">Stations</h3>
                        <h4 class=""></h4>
                    </div>
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        ...
                        <li>/</li>
                        <li class="c-state_active">Stations</li>
            ...
            <div class="c-content-title-1">
                        <h3 class="c-center c-font-uppercase c-font-bold">Add Stations</h3>
                        ...
                        <form method="POST" action="<?php echo base_url(); ?>index.php/Station/<?php if(isset($station)) echo 'edit'; else echo 'addstation'; ?>">
                            <?php if(isset($station)) {
                            ?>
                                <input type="hidden" name="id" value="<?php echo $station->id; ?>">
                            <?php } ?>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-md-4 control-label input-lg">Station Name</label>
                            <div class="col-md-6">
                                <input type="text" name="name" class="form-control  c-square c-theme" value="<?php if(isset($station)){ echo $station->name; } ?>" id="name" placeholder="Station Name" required> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="Username"  class="col-md-4 control-label input-lg">Location</label>
                            <div class="col-md-6">
                                <input type="text" name="location" class="form-control  c-square c-theme" id="location" placeholder="Location" value="<?php if(isset($station)){ echo $station->location; } ?>" required> 
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="inputPassword3" class="col-md-4 control-label input-lg">Station Cash</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control  c-square c-theme" id="cash" name="cash" placeholder="Account Cash" value="<?php if(isset($station)){ echo $station->cash; } ?>" required> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label>&nbsp;</label>
                                <button type="submit" name="btn_Adduser" class="btn btn-primary btn-lg btn-block"><?php if(isset($station)) echo "Update"; else echo "Add User"; ?></button>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?> 
                                                    <tr>
                                                        ...
                                                        <td><?php echo $station->cash; ?></td>
                                                        <td><a href="<?php echo base_url(); ?>index.php/Station/get/<?php echo base64_encode($station->id); ?>" onClick="return conformation();" style="float:left;"><b>Edit</b></a></td>
                                                    </tr>  
