 ...
 #trigger-upload {
    ...
    <body class="c-layout-header-fixed c-layout-header-6-topbar">
            ...
            <div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
                <div class="container" >
                    <div class="c-page-title c-pull-left">
                        <h3 class="c-font-uppercase c-font-bold">Imports</h3>
                    ...
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        ...
                        <li>/</li>
                        <li class="c-state_active">Imports</li>
                    </ul>
                </div>
            </div>
     ...
     ?>
        ...
        <tr  class="odd gradeX">
            <td class="hidden-480"><?php echo $x; ?><input type="hidden" class="id" value="<?php echo ucfirst($import->id); ?>"></td>
            <td class="hidden-480 token"><?php echo ucfirst($import->name); ?></td>
            <td class="hidden-480"><?php echo $import->chassis; ?></td>
            <td class="hidden-480"><?php echo ucfirst($import->station); ?></td>
            <td class="hidden-480"><?php echo ucfirst($import->status); ?></td>      
            <td class="hidden-480"><?php echo date('d M, Y',strtotime($import->date)); ?></td> 
        </tr> 
...
<script src="<?php echo base_url(); ?>assets/core/import.js"></script>
