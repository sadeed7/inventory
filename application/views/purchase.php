    ...
    <body class="c-layout-header-fixed c-layout-header-6-topbar">
            ...
            <div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
                <div class="container" >
                    ...
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        ...
                        <li>/</li>
                        <li class="c-state_active">Purchase Report</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="c-content-box  c-overflow-hide c-bg-white">
                ...
                <div class="container">
                     <div class="row">
                        ...
                        <form method="POST" action="<?php echo base_url(); ?>index.php/Report/getpurchase">
                ...
                <div class="row">
                            ...
                            <h1><b>Purchase Report<?php if(isset($from) && isset($to)) echo "(".date('d M, Y', strtotime($from))."-".date('d M, Y', strtotime($to)).")"; ?></b></h1>

                            <hr>
                            <div class="col-md-6 text-center" style="border:1px solid;color:white;background-color:#5E9CD1">
                                
                                <label><b> Total Purchases :  <?php if(isset($count)) echo $count; else echo 0;?></b></label>
                            </div>
                            <div class="col-md-6 text-center" style="border:1px solid;color:white;background-color:#5E9CD1">
                                <label><b> Total Cost :  $<?php if(isset($total)) echo $total; else echo 0;?></b></label>
                            </div>
                            <div class="clearfix"></div>
                            <br>
     ...
     <tbody id="tablestockin">
                                   ...
                                   <?php if(isset($purchases) && $purchases){
                                            ...
                                            ?>
                                                    <tr  class="odd gradeX">
                                                        <td class="hidden-480"><?php echo $index; ?><input type="hidden" class="id" value="<?php echo $purchase->id; ?>"></td>
                                                        <td class="hidden-480 token"><?php echo $purchase->name; ?></td>
                                                        <td class="hidden-480"><?php echo $purchase->chassis; ?></td>
                                                        <td class="hidden-480"><?php echo $purchase->location; ?></td>
                                                        <td class="hidden-480"><?php echo $purchase->price; ?></td>
                                                        <td class="hidden-480"><?php echo $purchase->status; ?></td>
                                                        <td class="hidden-480"><?php echo date('d M, Y',strtotime($purchase->date)); ?></td> 
                                                    </tr>
                                            <?php        
                                                $index++;
                                                }
...
<script src="<?php echo base_url(); ?>assets/core/purchases.js"></script>
