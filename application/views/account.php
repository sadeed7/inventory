            ...
            <div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
                <div class="container" >
                    ...
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        ...
                        <li>/</li>
                        <li class="c-state_active">Account Details</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="container">
                     <div class="row">
                        ...
                        ?>
                               ...
                               <div class="row">
                                    <form method="POST" action="<?php echo base_url(); ?>index.php/Report/getaccountdetails">
                                    <?php if ($userdata['role'] === 'admin') {
                                    ?>
                            ...
                            <h1><b>Account Details<?php if(isset($from) && isset($to)) echo "(".date('d M, Y', strtotime($from))."-".date('d M, Y', strtotime($to)).")"; ?></b></h1>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="row" id="filter">
                                    ...
                                    <table  cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tablestockin" style="overflow-y: scroll;">
                                            ...
                                            ?>  
                                                    <tr  class="odd gradeX">
                                                        ...
                                                        <td class="hidden-480"><?php echo date('d M, Y',strtotime($detail->date)); ?></td>
                                                        <td class="hidden-480 token"><?php echo $detail->type; ?></td>

                                                        <td class="hidden-480"><?php echo $detail->price; ?></td>
                                                        <td class="hidden-480"><?php echo $detail->refrence; ?></td>
                                                        <td class="hidden-480"><?php echo $detail->location; ?></td>
                                                        <td class="hidden-480"><?php echo $detail->balance; ?></td>
