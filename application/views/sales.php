            ...
            <div class="c-layout-breadcrumbs-1 c-subtitle c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
                <div class="container" >
                    ...
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        ...
                        <li>/</li>
                        <li class="c-state_active">Sales Report</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="container">
                     <div class="row">
                        ...
                        ?>
                               ...
                               <div class="row">
                                    <form method="POST" action="<?php echo base_url(); ?>index.php/Report/getsales">
                                    <?php if ($userdata['role'] === 'admin') {
                                    ?>
                            ...
                            <h1><b>Sales Report<?php if(isset($from) && isset($to)) echo "(".date('d M, Y', strtotime($from))."-".date('d M, Y', strtotime($to)).")"; ?></b></h1>

                            <hr>
                            <div class="col-md-6 text-center" style="border:1px solid;color:white;background-color:#5E9CD1">
                                
                                <label><b> Total Vehicles Sold :  <?php if(isset($count)) echo $count; else echo 0; ?></b></label>
                            </div>
                            <div class="col-md-6 text-center" style="border:1px solid;color:white;background-color:#5E9CD1">
                                <label><b> Total Sales :  $<?php if(isset($total)) echo $total; else echo 0; ?></b></label>
                            </div>
                            <div class="clearfix"></div>
                            <br>
                                ...
                                <div class="row" id="filter">
                                    ...
                                    <table  cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
                                        ...
                                        <tbody id="tablestockin">
                                            ...
                                            ?>
                                                    <tr  class="odd gradeX">
                                                        <td class="hidden-480"><?php echo $index; ?></td>
                                                        <td class="hidden-480 token"><?php echo $sale->name; ?></td>
                                                        <td class="hidden-480"><?php echo $sale->chassis; ?></td>
                                                        <td class="hidden-480"><?php echo $sale->location; ?></td>
                                                        <td class="hidden-480"><?php echo $sale->price; ?></td>
                                                        <td class="hidden-480"><?php echo date('d M, Y',strtotime($sale->date)); ?></td> 
                                                    </tr>
                                            <?php        
                                                $index++;
                                                }
                    ...
                    <div class="modal-body">
                        <div class="row">
                                ...
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <!-- <img src="1.jpg" style="width:330px; height:300px;border: 2px solid grey;"> -->
                                        </div>

                                        <div class="item">
                                            <!-- <img src="2.jpg" style="width:330px; height:300px;border: 2px solid grey;"> -->
                                        </div>
                            ...
                            <div class="col-md-5 ">
                                ...
                                <label>Added By: User Name(Station Name)</label>
                                <label>Current Location: Station 2</label>
                                <label>Price: $12.000</label>
                                <br>
                                <label>Status: <span class="alert-success">Sold</span></label>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                        ...
                        <div class="row" id="exportData" style="display:none;">
                            <form>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control c-square c-theme">
                                            ...
                                            <option>Station Name 1</option>
                                            <option>Station Name 2</option>
                                            <option>Station Name 3</option>
                                            <option>Station Name 4</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control c-square c-theme" name="vdelivtime" id="vdelivtime" placeholder="dd/mm/yyyy" required="">
                                    </div>
                        ...
                        <div class="row" id="sellData" style="display:none;">
                            <form>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control c-square c-theme" name="vprice" id="vprice" placeholder="$Price" required="">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group c-margin-t-40">
